...
private:
    ...
    rclcpp::Subscription<std_msgs::msg::String>::SharedPtr qrcoder_subscriber_;
    ...
    void subscription_callback_qrcoder(const std_msgs::msg::String::SharedPtr qrcode_msg);
    ...
    void park(void);
    void QR_follow();
    float value_limit(float origin, float limit);
    ...
    float P_confidence_th = 0.5;
    float recognize_P_conf_th = 0.5;
    //  temp值限制
    int temp_lim = 20; 
    
    float re_vel = 0.2;
    int re_tim = 200; 
    int line_cnt_th = 2000; 
    int P_cnt_th = 20; 
    ...
    int P_bottom_th=400;
    float QR_confidence_th = 0.8;
    float QR_follow_vel = 0.3;
    float QR_follow_raio = 2.0;
    int ob_line_x_I = 30;
    int ob_line_x_III = 30;
    int QR_cnt_th = 20;
    int QR_x_th;
    int ob_x_error_l_th;
    int ob_x_error_r_th;
